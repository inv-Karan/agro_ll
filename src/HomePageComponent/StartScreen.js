...
const StartScreen = () => 
<div id="start-screen" className="start-screen start-screen--style-1" data-scroll-discover="true"></div>
<div id="start-screen__bg" className="start-screen__bg"></div>
    <div id="vegas-slider" data-dots="true" style={{height: "560px"}} className="vegas-container"><div className="vegas-slide vegas-transition-swirlLeft vegas-transition-swirlLeft-in vegas-transition-swirlLeft-out" style={{transition: "all 4000ms ease 0s"}}>
    ...
    <div className="vegas-overlay" style="background-image: url(&quot;img/home_img/overlays/05.png&quot;);">
    </div>
    ...
    //                                 var $this = this,
    //                                     dots = $('<nav className="vegas-dots"></nav>');

    //                                 $this.find('.vegas-control').append(dots);

    //                                 for (var i = 0; i < slides.length; i++) {
    //                                     x = $('<a "href="#" className="paginatorLink"></a>');
...
<div id="start-screen__content-container" class="start-screen__content-container  text-white">
					<div class="start-screen__content__item start-screen__content__item--1  align-items-center is-active">
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-12 col-md-10 col-xl-8">
									<div class="__name">My Farm Easy</div>
						...
						<div class="container">
							<div class="row align-items-center">
								...
								<div class="col-12 col-md-auto col-lg-3 col-xl-4  text-center">
									<a class="play-btn" data-fancybox="" href="https://www.youtube.com/watch?v=kC7nt09wsdM">
										<span></span>
									</a>
								</div>
							</div>
